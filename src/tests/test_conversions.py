...
from parseinlinemarkdown import split_nodes_delimiter
...
class TestConversions(unittest.TestCase):
    def test_split_bold(self):
        ...
        results = split_nodes_delimiter([node], "**")
        #print(results)
    ...
    def test_split_italics(self):
        ...
        results = split_nodes_delimiter([node], "_")
        self.assertEqual(len(results), 3)
    ...
    def test_multi_nodes(self):
        ...
        results = split_nodes_delimiter(nodes, "**")
